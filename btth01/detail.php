        ...
        <!-- <h3 class="text-center text-uppercase mb-3 text-primary">CẢM NHẬN VỀ BÀI HÁT</h3> -->
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p class="card-text"><span class=" fw-bold">Bài hát: </span><?= $member['ten_bhat'] ?></p>
                        <p class="card-text"><span class=" fw-bold">Thể loại: </span><?= $member['ten_tloai'] ?></p>
                        <p class="card-text"><span class=" fw-bold">Tóm tắt: </span><?= $member['tomtat'] ?></p>
                        <p class="card-text"><span class=" fw-bold">Nội dung: </span><?= $member['noidung'] ?></p>
                        <p class="card-text"><span class=" fw-bold">Tác giả: </span><?= $member['ten_tacgia'] ?></p>
