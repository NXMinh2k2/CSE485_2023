...
<body>
    ...
    <main class="container-fluid mt-3">
        ...
        <div class="row">
            <?php 
                foreach($member as $song) {
            ?>
                    <div class="col-sm-3">
                        <div class="card mb-2" style="width: 100%;">
                            <img src="images/songs/<?= $song['hinhanh'] ?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title text-center">
                                    <a href="detail.php?ma_bviet=<?= $song['ma_bviet'] ?>" class="text-decoration-none"><?= $song['ten_bhat'] ?></a>
                                </h5>
                            </div>
                        </div>
                    </div> 
